...
| A change to a **wire contract** | `docs/rest-api.md`, `osc-spec.md`, `midi-spec.md`, `mqtt-spec.md`, `audio-ws-spec.md`, `pfst-v2-spec.md` | the spec: bump its version line and add a Version history row | `docs-links` |
