...
# vertex: LIGHT
ax.text(4.6, 9.35, "LIGHT", fontsize=16, ha="center", color=ORANGE)
ax.text(4.6, 8.8, "visual artists\npatterns · the wall · forks", fontsize=11,
        ha="center", va="center", color=INK)

# vertex: SOUND
ax.text(1.55, 3.1, "SOUND", fontsize=16, ha="center", color=ORANGE)
ax.text(1.75, 2.35, "sound artists\nOSC both ways · Ableton / Max / TD\naudio-react", fontsize=11,
        ha="center", va="center", color=INK)

# vertex: TOUCH
ax.text(7.6, 3.1, "TOUCH", fontsize=16, ha="center", color=ORANGE)
ax.text(7.5, 2.35, "makers\nfour knobs · soldering\nenclosures in any material", fontsize=11,
        ha="center", va="center", color=INK)

# the device at the centroid — instrument no. 1
dx, dy, dw, dh = 3.55, 4.6, 1.9, 2.0
...
ax.text(2.0, 7.45, "Instagram", fontsize=13.5, ha="center", color=INK)
ax.text(2.0, 6.95, "the proving ground —\nevery pattern meets the\npublic within hours", fontsize=9.5,
...
# legend
ax.text(15.3, 9.3, "solid — exists today\ndashed — a direction", fontsize=10,
