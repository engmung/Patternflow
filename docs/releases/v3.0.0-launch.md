...
> **Historical (2026-07).** The one-off checklist used for the v3.0.0 release. The current procedure is [`docs/RELEASING.md`](../RELEASING.md); release notes since 3.2 live on [GitHub Releases](https://github.com/engmung/Patternflow/releases).
...
- [x] **PASSED (2026-07-19).** The v3 `encloser.stl` printed, assembled with a v3.0 board, and works — documented end to end in the [assembly video](https://youtu.be/J9C9bZgkNKs), §9 checks included.
