...
import type { Edition } from "./editions-data";
...
const REASON_LABEL: Record<NonNullable<Edition["reason"]>, string> = {
...
export default function EditionCard({ edition: v }: Props) {
