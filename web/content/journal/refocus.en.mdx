...
<figure className="journal-md-figure">
  <img src="/journal/refocus/clean-3d-print.jpg" alt="Clean shot of the existing Patternflow body" />
  <figcaption>A cleaner shot of the existing Patternflow body.</figcaption>
</figure>
