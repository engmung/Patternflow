...
<!-- GENERATED by firmware/toolchain/build_audio_in_page.py from
     tools/patternflow-audio-extension (editor 7441b06571).
...
<div class="page">
  ...
  <div class="panel">
    ...
    <div class="col grow">
      ...
      <div class="field">
        <span class="fieldLabel">Drives knob</span>
        <div class="seg">
          <button class="knobBtn" type="button">K1</button>
          <button class="knobBtn" type="button">K2</button>
          <button class="knobBtn" type="button">K3</button>
          <button class="knobBtn" type="button">K4</button>
        </div>
      </div>
  ...
  <div class="chips">
    <button class="chipCard" id="chip0" type="button"><span class="chipDot"></span><span class="chipName mono">B1</span><span class="chipHz mono dimText">62–375</span><span class="arrow">&#8594;</span><span class="chipKnob mono">K1</span><canvas></canvas></button>
    <button class="chipCard" id="chip1" type="button"><span class="chipDot"></span><span class="chipName mono">B2</span><span class="chipHz mono dimText">250–2k</span><span class="arrow">&#8594;</span><span class="chipKnob mono">K2</span><canvas></canvas></button>
    <button class="chipCard" id="chip2" type="button"><span class="chipDot"></span><span class="chipName mono">B3</span><span class="chipHz mono dimText">2k–5k</span><span class="arrow">&#8594;</span><span class="chipKnob mono">K3</span><canvas></canvas></button>
    <button class="chipCard" id="chip3" type="button"><span class="chipDot"></span><span class="chipName mono">B4</span><span class="chipHz mono dimText">5k–16k</span><span class="arrow">&#8594;</span><span class="chipKnob mono">K4</span><canvas></canvas></button>
  </div>
