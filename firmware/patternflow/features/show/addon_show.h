...
// This feature's descriptor lives in feature_show.h; the tree was addons/ and
// the file was addon_show.h until the vocabulary settled on "feature". An
...
#pragma once
#include "feature_show.h"
namespace PFAddonShow = PFFeatureShow;
