...
// This feature's descriptor lives in feature_mqtt.h; the tree was addons/ and
// the file was addon_mqtt.h until the vocabulary settled on "feature". An
...
namespace PFAddonMqtt = PFFeatureMqtt;
