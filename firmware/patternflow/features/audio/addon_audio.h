...
// This feature's descriptor lives in feature_audio.h; the tree was addons/ and
// the file was addon_audio.h until the vocabulary settled on "feature". An
...
namespace PFAddonAudio = PFFeatureAudio;
