// ═══════════════════════════════════════════════════════════
// PatternFlow - Shared noise helpers (Perlin 2D, fractal noise)
// Stateless; safe to call from any pattern's draw().
// License: MIT
// ═══════════════════════════════════════════════════════════
#pragma once
...
inline float fractal2D(float x, float y, int octaves, float roughness) {
