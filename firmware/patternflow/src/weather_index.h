...
<nav class="pfnav"><a href="/">Console</a><a href="/patterns">Patterns</a><a href="/show">Sequences</a><a href="/audio">Audio</a><a href="/status">Status</a><a href="/wifi">Wi-Fi</a><a href="/mqtt">MQTT</a><a href="/weather" class="here">Weather</a><a href="/update">Update</a><label class="pf-theme"><input type="checkbox" id="pfTheme"> Light</label></nav>
...
(function(){var c=document.getElementById('pfTheme');if(!c)return;c.checked=document.documentElement.getAttribute('data-theme')==='light';c.onchange=function(){var on=c.checked;document.documentElement.setAttribute('data-theme',on?'light':'dark');try{localStorage.setItem('pf-theme',on?'light':'dark')}catch(e){}}})();
</script>
</body></html>
)HTML";
