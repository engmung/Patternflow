...
<nav class="pfnav"><a href="/">Console</a><a href="/patterns">Patterns</a><a href="/show" class="here">Sequences</a><a href="/audio">Audio</a><a href="/status">Status</a><a href="/wifi">Wi-Fi</a><a href="/mqtt">MQTT</a><a href="/weather">Weather</a><a href="/update">Update</a><label class="pf-theme"><input type="checkbox" id="pfTheme"> Light</label></nav>
