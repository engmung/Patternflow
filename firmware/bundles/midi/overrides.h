// ═══════════════════════════════════════════════════════════
// Patternflow MIDI — what this edition calls itself, and what it sets
//
...
// shelf at all, not a courtesy. What does change is outside this file: the
// firmware_midi env puts the USB port on the OTG stack (platformio.ini).
